...
# NOTE: 5.6.13 commented out as running 4 mysql servers causes
#       inconsistent behavior with Travis CI
# wget http://downloads.mysql.com/archives/get/file/mysql-5.6.13-linux-glibc2.5-x86_64.tar.gz
# tar -zxf mysql-5.6.13-linux-glibc2.5-x86_64.tar.gz
...
# Initialize information database
./scripts/mysql_install_db --datadir=./data/mysql --user=$USER
# Duplicate initial data for use with 5.6.13
# cp -P -r data/mysql ../mysql-5.6.13-linux-glibc2.5-x86_64/data
...
# Prepare 5.6.13
# cd mysql-5.6.13-linux-glibc2.5-x86_64/
# 
# mkdir -p data/mysql/data/tmp
# 
# # Copy configuration
# cp ../test/travis/my.5.6.13.cnf ./my.cnf
# mkdir binlog
# touch binlog/mysql-bin.index
# 
